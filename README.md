...
12. Expand the **_"Gradle Scripts"_** menu and open **_"build.gradle(Module: app)"_**. Replace the old package name defined in **_"applicationId"_** with the new one. <dl />For example: **_applicationId "com.peppe130.newrominstaller"_**
